      ...
      <section className="section">
        <div className="container">
          <div className="content">
            ...
            <p>This page contains live statistics mentioned in the paper:</p>
            <p>
              Erik Wittern, Philippe Suter, Shriram Rajagopalan "A Look at the
              Dynamics of the JavaScript Package Ecosystem",{" "}
              <em>
                2016 IEEE/ACM 13th Working Conference on Mining Software
                Repositories
              </em>{" "}
              (2016). [DOI:{" "}
              <a href="https://doi.org/10.1145/2901739.2901743">
                        ...
                        <li key={d._id}>
                          <span>
                            <strong>
                              ...
                              (
                              {Number(
                                (d.count * 100.0) / this.state.sum
                              ).toFixed(2)}
                              %)
                            </strong>{" "}
                            packages have <strong>{d._id}</strong>{" "}
                            {d._id === 1 ? (
                        ...
                        <li key={d._id}>
                          <span>
                            <strong>
                              ...
                              (
                              {Number(
                                (d.count * 100.0) / this.state.sumDev
                              ).toFixed(2)}
                              %)
                            </strong>{" "}
                            packages have <strong>{d._id}</strong>{" "}
